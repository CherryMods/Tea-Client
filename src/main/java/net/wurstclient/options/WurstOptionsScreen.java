...
public class WurstOptionsScreen extends Screen {
    ...
    private void addLinkButtons() {
        ...
        new WurstOptionsButton(54, 72, () -> "Tea Source", "GitHub",
        ...
        new WurstOptionsButton(54, 96, () -> "Wurst Twitter", "@Wurst_Imperium",
                b -> os.open("https://www.wurstclient.net/options-twitter/"));

        new WurstOptionsButton(54, 120, () -> "Donate To Wurst",
                "§n§lWurstClient.net/donate\n"
                        + "Donate now to help Alexander keep Wurst Client alive and free"
                        + " to use for everyone.\n\n"
